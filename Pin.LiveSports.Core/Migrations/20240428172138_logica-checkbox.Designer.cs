...
namespace Pin.LiveSports.Core.Migrations
{
    ...
    [Migration("20240428172138_logica-checkbox")]
    partial class logicacheckbox
    {
            ...
            modelBuilder.Entity("Pin.LiveSports.Core.Entities.Tournament", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 8, 6, 19, 21, 38, 629, DateTimeKind.Local).AddTicks(9040),
                            Name = "The Grand Duelist Gala",
                            StartDate = new DateTime(2024, 8, 4, 19, 21, 38, 629, DateTimeKind.Local).AddTicks(8990)
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000011"),
                            EndDate = new DateTime(2024, 9, 25, 19, 21, 38, 629, DateTimeKind.Local).AddTicks(9050),
                            Name = "The Blade Masters Summit",
                            StartDate = new DateTime(2024, 9, 20, 19, 21, 38, 629, DateTimeKind.Local).AddTicks(9050)
                        });
                });
