...
namespace Pin.LiveSports.Core.Migrations
{
    ...
    [Migration("20240519173008_require-name")]
            ...
            modelBuilder.Entity("Pin.LiveSports.Core.Entities.Tournament", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 8, 27, 19, 30, 8, 372, DateTimeKind.Local).AddTicks(9390),
                            Name = "The Grand Duelist Gala",
                            StartDate = new DateTime(2024, 8, 25, 19, 30, 8, 372, DateTimeKind.Local).AddTicks(9340)
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000011"),
                            EndDate = new DateTime(2024, 10, 16, 19, 30, 8, 372, DateTimeKind.Local).AddTicks(9390),
                            Name = "The Blade Masters Summit",
                            StartDate = new DateTime(2024, 10, 11, 19, 30, 8, 372, DateTimeKind.Local).AddTicks(9390)
                        });
                });
