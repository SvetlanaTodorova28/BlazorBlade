...
namespace Pin.LiveSports.Core.Migrations
{
    ...
    [Migration("20240428163459_change-ratings")]
            ...
            modelBuilder.Entity("Pin.LiveSports.Core.Entities.Tournament", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 8, 6, 18, 34, 59, 613, DateTimeKind.Local).AddTicks(4760),
                            Name = "The Grand Duelist Gala",
                            StartDate = new DateTime(2024, 8, 4, 18, 34, 59, 613, DateTimeKind.Local).AddTicks(4720)
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000011"),
                            EndDate = new DateTime(2024, 9, 25, 18, 34, 59, 613, DateTimeKind.Local).AddTicks(4770),
                            Name = "The Blade Masters Summit",
                            StartDate = new DateTime(2024, 9, 20, 18, 34, 59, 613, DateTimeKind.Local).AddTicks(4770)
                        });
                });
